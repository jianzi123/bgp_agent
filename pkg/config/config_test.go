...
import (
	...
	//"github.com/osrg/gobgp/check/pkg/config"
	"testing"
)
...
func Test_LoadConfigFIle(t *testing.T)  {
	...
	ioutil.WriteFile("/Users/wangshuaijian/go_workspace/src/bgp_agent/test-script/config.json", buff, os.ModePerm)
	//LoadConfigFIle("/Users/wangshuaijian/go_workspace/src/bgp_agent/test-script/server.toml", "toml", "")
